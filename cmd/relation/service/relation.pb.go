...
type RelationActionRequest struct {
	...
	ToUserId   int64  `protobuf:"varint,3,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty"`     // 视频id
	ActionType int32  `protobuf:"varint,4,opt,name=action_type,json=actionType,proto3" json:"action_type,omitempty"` // 1 关注 2 取消
}
...
type FollowerListResponse struct {
	...
	StatusCode int32   `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"` // 状态码0成功
	StatusMsg  string  `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty"`     // 状态描述
	UserList   []*User `protobuf:"bytes,3,rep,name=user_list,json=userList,proto3" json:"user_list,omitempty"`        //粉丝列表
}
...
type FollowListResponse struct {
	...
	StatusCode int32   `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"` // 状态码0成功
	StatusMsg  string  `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty"`     // 状态描述
	UserList   []*User `protobuf:"bytes,3,rep,name=user_list,json=userList,proto3" json:"user_list,omitempty"`        // 关注列表
}
...
var file_relation_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x85, 0x01, 0x0a, 0x15, 0x52,
	...
	0x70, 0x65, 0x22, 0x58, 0x0a, 0x16, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x63,
	...
	0x09, 0x52, 0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x22, 0x44, 0x0a, 0x13,
	...
	0x49, 0x64, 0x22, 0x83, 0x01, 0x0a, 0x14, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x4c,
	...
	0x75, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x42, 0x0a, 0x11, 0x46, 0x6f, 0x6c, 0x6c,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x81, 0x01, 0x0a,
	...
	0x6c, 0x6c, 0x6f, 0x77, 0x32, 0xf9, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x12, 0x53, 0x0a, 0x0e, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x63, 0x74,
	...
	0x4c, 0x69, 0x73, 0x74, 0x12, 0x1b, 0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e,
	...
	0x65, 0x12, 0x4d, 0x0a, 0x0c, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x4c, 0x69, 0x73,
	0x74, 0x12, 0x1d, 0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x46, 0x6f, 0x6c,
	0x6c, 0x6f, 0x77, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1e, 0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x46, 0x6f, 0x6c, 0x6c,
	0x6f, 0x77, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x42, 0x15, 0x5a, 0x13, 0x2e, 0x2e, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x3b, 0x72,
...
var file_relation_proto_goTypes = []interface{}{
	...
	(*FollowerListRequest)(nil),    // 2: relation.FollowerListRequest
	(*FollowerListResponse)(nil),   // 3: relation.FollowerListResponse
	(*FollowListRequest)(nil),      // 4: relation.FollowListRequest
	(*FollowListResponse)(nil),     // 5: relation.FollowListResponse
	(*User)(nil),                   // 6: relation.User
}
var file_relation_proto_depIdxs = []int32{
	6, // 0: relation.FollowerListResponse.user_list:type_name -> relation.User
	6, // 1: relation.FollowListResponse.user_list:type_name -> relation.User
	0, // 2: relation.Relation.RelationAction:input_type -> relation.RelationActionRequest
	4, // 3: relation.Relation.FollowList:input_type -> relation.FollowListRequest
	2, // 4: relation.Relation.FollowerList:input_type -> relation.FollowerListRequest
	1, // 5: relation.Relation.RelationAction:output_type -> relation.RelationActionResponse
	3, // 6: relation.Relation.FollowList:output_type -> relation.FollowerListResponse
	3, // 7: relation.Relation.FollowerList:output_type -> relation.FollowerListResponse
