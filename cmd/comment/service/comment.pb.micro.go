...
type DyCommentService interface {
	CreateComment(ctx context.Context, in *CommentActionRequest, opts ...client.CallOption) (*CommentActionResponse, error)
	DeleteComment(ctx context.Context, in *CommentActionRequest, opts ...client.CallOption) (*CommentActionResponse, error)
...
func (c *dyCommentService) CreateComment(ctx context.Context, in *CommentActionRequest, opts ...client.CallOption) (*CommentActionResponse, error) {
...
func (c *dyCommentService) DeleteComment(ctx context.Context, in *CommentActionRequest, opts ...client.CallOption) (*CommentActionResponse, error) {
...
func RegisterDyCommentHandler(s server.Server, hdlr DyCommentHandler, opts ...server.HandlerOption) error {
	type dyComment interface {
		CreateComment(ctx context.Context, in *CommentActionRequest, out *CommentActionResponse) error
		DeleteComment(ctx context.Context, in *CommentActionRequest, out *CommentActionResponse) error
...
func (h *dyCommentHandler) CreateComment(ctx context.Context, in *CommentActionRequest, out *CommentActionResponse) error {
	return h.DyCommentHandler.CreateComment(ctx, in, out)
}

func (h *dyCommentHandler) DeleteComment(ctx context.Context, in *CommentActionRequest, out *CommentActionResponse) error {
